...
<div class="container py-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <h2 class="text-success">{{ $product->formatted_price }}</h2>
            <p class="text-muted">Stock disponible: <strong>{{ $product->stock }} unidades</strong></p>
...
<div class="mt-4">
    ...
    <div class="row align-items-center g-2">
        <div class="col-4">
            <div class="input-group">
                ...
                <input type="number" id="quantity" value="1" min="1" max="{{ $product->stock }}" class="form-control text-center" style="max-width: 70px;">
    ...
    <div class="text-center p-3 border rounded h-100">
        ...
        <p class="small">{{ $product->eco_feature }}</p>
    </div>
</div>
                <div class="col-md-4">
                    <div class="text-center p-3 border rounded h-100">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><strong>♻️ Materiales:</strong> {{ $product->eco_feature }}</li>
