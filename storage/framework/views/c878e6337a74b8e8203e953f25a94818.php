                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3 pb-3 border-bottom align-items-center">
                            <div class="col-2">
                                <img src="<?php echo e($item->product->image_url); ?>" class="img-fluid rounded" style="height: 60px; object-fit: cover;">
                            </div>
                            <div class="col-4">
                                <h6 class="mb-0"><?php echo e($item->product->name); ?></h6>
                                <small class="text-muted"><?php echo e($item->product->formatted_price); ?></small>
                            </div>
                            <div class="col-3">
                                <form action="<?php echo e(route('cart.update', $item->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <input type="number" name="quantity" value="<?php echo e($item->quantity); ?>" min="1" class="form-control form-control-sm" style="width: 70px;" onchange="this.form.submit()">
                                </form>
                            </div>
                            <div class="col-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <strong class="text-success fs-4">$<span id="totalWithDiscount"><?php echo e(number_format($total, 2)); ?></span></strong>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ecotech2\resources\views/cart/index.blade.php ENDPATH**/ ?>